...
public class Restaurant {
    ...
    public class Tester {
        public static void main(String[] args) {
            ...
            Restaurant restaurant1 = new Restaurant("SwiftFood", restaurantContacts,
                    "Carolina Street, Springfield, 62702", 4.1f);
            System.out.println("Displaying restaurant details \n***************");
            System.out.println("Restaurant Name : " + restaurant1.getRestuarnatName());
            System.out.println("Restaurant Rating : " + restaurant1.getRating());
            System.out.println("Restaurant Contacts:" + restaurant1.getRestaurantAddress());
            Restaurant restaurant2 = new Restaurant("SwiftFood", restaurantContacts,
                    "Carolina Street, Springfield, 62702", 4.1f);
            System.out.println("Restaurant Name : " + restaurant2.getRestuarnatName());
            System.out.println("Restaurant Rating : " + restaurant2.getRating());
            System.out.println("Restaurant Contacts:" + restaurant2.getRestaurantAddress());

            Restaurant restaurant3 = new Restaurant("SwiftFood", restaurantContacts,
                    "Carolina Street, Springfield, 62702", 4.1f);
